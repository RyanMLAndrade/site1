      ...
      res.send(`
        ...
        <head>
          ...
          <style>
            ...
            body.dark-mode .file-item button { background-color: #dc3545; color: white; }
            body.dark-mode .file-item button:hover { background-color: #c82333; }
            ...
            textarea { width: 100%; min-height: 400px; font-size: 1rem; padding: 1rem; box-sizing: border-box; border: 1px solid #ccc; border-radius: 4px; }
