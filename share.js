...
// O arquivo share.js agora recebe as dependências do server.js
module.exports = (redis, upload, uploadFolder) => {
  ...
  router.get("/sala", async (req, res) => {
    ...
    if (!senha) {
      // Redireciona para a página de senha caso não haja senha
  ...
  // Exporta o roteador para ser usado pelo server.js
  return router;
};
